...
IMPORTANT: CalendarEvent.resource MUST include `planId?: string` for drag-drop calendar plan filtering.
  </action>
  <verify>
...
- workoutToCalendarEvent includes planId: workout.planId in the resource object
- expandRecurringEvent includes planId: workout.planId in the resource object
  </done>
</task>
...
5. CalendarEvent.resource includes planId field
6. workoutToCalendarEvent populates planId from workout.planId
</verification>
...
- CalendarEvent type includes planId?: string in resource object
- workoutToCalendarEvent populates planId in resource from workout.planId
</success_criteria>
