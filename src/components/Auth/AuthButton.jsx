...
function AuthButton({ onLoginClick, onAdminClick }) {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 px-4 py-2 text-sm font-medium bg-blade-blue hover:bg-blade-blue/90 text-white rounded-xl transition-all duration-200"
    >
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
