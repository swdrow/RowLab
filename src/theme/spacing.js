/**
 * Liquid Glass Spacing System
 *
 * Philosophy:
 * - Consistent spacing scale based on 4px grid
 * - Optimal spacing for touch targets (minimum 44px)
 * - Breathing room for glass elements
 */
...
export const liquidGlassSpacing = {
  ...
  semantic: {
    ...
    touchTarget: '2.75rem',  // 44px (iOS minimum)
  },
  ...
  radius: {
    ...
    base: '0.5rem',    // 8px - standard cards
...
export default liquidGlassSpacing;
