      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-bdr-primary">
            ...
            <th className="text-left py-3 px-4 text-sm font-medium text-txt-secondary">Boat Class</th>
            <th className="text-left py-3 px-4 text-sm font-medium text-txt-secondary">Notes</th>
        ...
        <tbody>
          {shells.map((shell) => (
            <tr key={shell.id} className="border-b border-bdr-primary/50 hover:bg-surface-hover transition-colors">
              ...
              <td className="py-3 px-4 text-txt-secondary">{shell.notes || '—'}</td>
              {canEdit && (
