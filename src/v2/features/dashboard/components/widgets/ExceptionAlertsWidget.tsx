    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between mb-4">
        <h3 className="font-medium text-txt-primary flex items-center gap-2">
          <Warning className="w-5 h-5 text-accent-primary" />
          Exception Alerts
        </h3>
      </div>
      ...
      <div className="flex-1 overflow-auto">
        {isLoading ? (
          ...
          <div className="text-center py-8 text-status-success">
            ...
            <p className="text-sm text-txt-muted mt-1">No exceptions detected</p>
          </div>
        ) : alertItems.length === 0 ? (
          ...
          <div className="space-y-2">
            {alertItems.map((item) => {
              ...
              const content = (
                <div
                  className="flex items-start gap-3 p-3 rounded-lg bg-surface-default
