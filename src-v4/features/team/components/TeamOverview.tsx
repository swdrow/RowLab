...
function CoachTools({ teamIdentifier }: { teamIdentifier: string }) {
  ...
  return (
    <Card padding="md" as="section">
      <h3 className="mb-4 text-sm font-display font-medium uppercase tracking-wider text-accent-sand">
        Coach Tools
      </h3>
    ...
    <Card padding="md" as="section">
      <form onSubmit={handleSubmit} className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-display font-medium text-text-bright">New Announcement</h3>
        </div>
        <input
          type="text"
          placeholder="Title"
...
function AnnouncementsSidebar({
  ...
  return (
    <div className="space-y-4">
      {pinned.length > 0 && (
        <Card padding="md" as="section">
          <h3 className="mb-3 flex items-center gap-1.5 text-sm font-display font-medium uppercase tracking-wider text-accent-sand">
