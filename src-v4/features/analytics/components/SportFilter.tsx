...
export function SportFilter({ value, onChange }: SportFilterProps) {
  return (
    <select
      ...
      className="rounded-lg bg-ink-base/50 border border-ink-border px-3 py-1.5 text-xs font-medium text-ink-secondary appearance-none cursor-pointer hover:border-ink-muted transition-colors focus:outline-none focus:ring-1 focus:ring-accent-copper/40 pr-7"
      style={{
